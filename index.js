...
function displayData(){
  data.forEach(function(an){
    const eachAnime=document.createElement('div')
    ...
    desc.textContent=an.description.substring(0,50)
    genre.textContent=an.genres
    genre.style.width="fit-content"
    //genre.style.overflow="auto"
    eachAnime.classList.add("box")
    eachAnime.append(title,desc,genre)
    link.appendChild(eachAnime)
